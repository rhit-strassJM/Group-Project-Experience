...
data_gender <- data_byCourse$"Woman"

sumColly <- apply(data_gender[,c(4:9)], 1, sum)
data_gender$sense_of_belonging <- sumColly
reduced <- data_gender[10:15] #looking at only the columns we want to compare
